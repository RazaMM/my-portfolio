...
<div class="flex flex-col gap-4 items-center justify-center p-2 bg-white text-center w-[24rem] h-[32rem] max-w-full max-h-full">
  <img class="w-56 rounded-[50%]" src={me} alt="A picture of Raza Mahmood wearing sunglasses" />
