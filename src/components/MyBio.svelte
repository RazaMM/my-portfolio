...
<div
  class="flex flex-col gap-4 items-center justify-center p-2 bg-white text-center w-80 h-[30rem] min-w-full min-h-full max-w-screen max-h-screen"
>
  <img class="w-56 rounded-sm select-none" src={me} alt="A picture of Raza Mahmood wearing sunglasses"/>
